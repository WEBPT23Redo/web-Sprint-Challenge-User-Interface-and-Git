...
The 4 areas of the box model would be: the content, padding, border and margin

4. While using flexbox, what axis does the following property work on: ```align-items: center```?

That would be the X axis

5. Explain why git is valuable to a team of developers. git allows you to save different versions of your software / web app. You are able to recover work in case of a power failure or your computer crashes.
